...
builder.Services.AddErgosfare(options =>
{
    options.AddCommandModule(module =>
    {
        ...
        module.Register<CreateOrderCommandHandler>();
...
Great, you're now set up with an Ergosfare project! From here, you can start exploring the core concepts that make Ergosfare powerful and flexible:
- [Configuring Ergosfare](/core-concepts/configuration)
- [Interceptors](/core-concepts/interceptors)
- [Modules & Extensions](/core-concepts/modules-and-extensions)
- [Polymorphism](/core-concepts/polymorphism)
