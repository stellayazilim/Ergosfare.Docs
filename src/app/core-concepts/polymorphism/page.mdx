...
{
    public Task HandleAsync(SunCommand command, IExecutionContext context, CancellationToken cancellationToken = default)
    {
...
{
    public Task HandleAsync(SiriusCommand command, IExecutionContext context, CancellationToken cancellationToken = default)
    {
...
- Consistency: Integrates seamlessly with Ergosfare’s pipeline and execution context.