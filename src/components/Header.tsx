      ...
      <div className="flex items-center gap-5">
        <nav className="hidden md:block">
          <ul role="list" className="flex items-center gap-8">
            <TopLevelNavItem href="https://github.com/stellayazilim/ergosfare">Github</TopLevelNavItem>
            <TopLevelNavItem href="https://stellayazilim.github.io/ergosfare.changelog">Changelog</TopLevelNavItem>
          </ul>
        </nav>
